EFFECT.Mat1 = Material( "hl2coop/ring1.png" )
EFFECT.Mat2 = Material( "hl2coop/ring2.png" )
EFFECT.Mat3 = Material( "hl2coop/ring3.png" )
EFFECT.Mat4 = Material( "hl2coop/run_point.png" )
...
function EFFECT:Think( )
	...
	self.Alpha = self.Alpha - speed * 0.2
